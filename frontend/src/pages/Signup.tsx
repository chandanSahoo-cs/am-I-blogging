...
const Signup = () => {
  ...
  useEffect(() => {
    const handleMouseMove = (e: MouseEvent) => {
      ...
      if (rightPanel) {
        rightPanel.style.transform = `translate(${x * 10}px, ${y * 10}px)`;
      }

      if (leftPanel) {
        leftPanel.style.transform = `translate(${x * -5}px, ${y * -5}px)`;
      }
    };
  ...
  <>
    <div className="min-h-screen flex flex-col md:flex-row overflow-hidden">
      ...
      <div className="fixed inset-0 -z-10 overflow-hidden">
        <motion.div
          className="absolute -top-[30%] -right-[10%] w-[70%] h-[70%] rounded-full bg-blue-50 opacity-60"
          animate={{
            scale: [1, 1.05, 1],
            opacity: [0.6, 0.7, 0.6],
          }}
        ...
        />
        <motion.div
          className="absolute top-[60%] -left-[10%] w-[50%] h-[50%] rounded-full bg-purple-50 opacity-40"
          animate={{
            scale: [1, 1.03, 1],
            opacity: [0.4, 0.5, 0.4],
          }}
